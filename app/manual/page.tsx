    ...
    <main className="min-h-screen bg-white dark:bg-gray-950 text-gray-900 dark:text-white">
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 space-y-12">
        ...
        <section id="hastkort">
            ...
            <table className="w-full text-sm border border-gray-800 rounded-xl overflow-hidden">
              ...
              <tbody className="divide-y divide-gray-800">
                {[
                  ...
                  <tr key={field} className="text-gray-300 hover:bg-gray-900 transition">
                    <td className="px-4 py-2 font-medium text-white whitespace-nowrap">{field}</td>
          ...
          <h3 className="text-white font-semibold mt-6 mb-2">Formscore – hur räknas det?</h3>
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
            {[
              ...
              <div key={pct} className="bg-gray-900 border border-gray-800 rounded-lg p-3 text-center">
                <p className="text-indigo-400 font-bold text-lg">{pct}</p>
        ...
        <section id="analys">
            ...
            <table className="w-full text-sm border border-gray-800 rounded-xl overflow-hidden">
              ...
              <tbody className="divide-y divide-gray-800">
                {[
                  ...
                  <tr key={col} className="text-gray-300 hover:bg-gray-900 transition">
                    <td className="px-4 py-2 font-medium text-white whitespace-nowrap">{col}</td>
                    <td className="px-4 py-2">{desc}</td>
                  </tr>
                ))}
              </tbody>
          ...
          <h3 className="text-white font-semibold mb-2">Beräkningsformel</h3>
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-4 font-mono text-sm text-gray-300 space-y-1">
            <p>Vinstchans =</p>
          ...
          <p className="text-gray-400 text-sm mt-2">
            Resultatet justeras med en <strong className="text-white">distansfaktor</strong> baserad på hästens historiska prestation på aktuell distans och startmetod.
          </p>

          <h3 className="text-white font-semibold mt-6 mb-2">Tolka resultatet</h3>
        ...
        <section id="grupper">
          ...
          <h3 className="text-white font-semibold mb-2">Skapa en grupp</h3>
          <Steps>
            ...
            <Step>En unik <strong className="text-white">inbjudningskod</strong> genereras – dela den med de du vill bjuda in.</Step>
          </Steps>

          <h3 className="text-white font-semibold mt-6 mb-2">Gå med i en grupp</h3>
          <Steps>
            <Step>Klicka på din avatar och välj <Kbd>Hantera sällskap</Kbd>.</Step>
            <Step>Välj <Kbd>Gå med i grupp</Kbd> och ange <strong className="text-white">inbjudningskoden</strong> du fått.</Step>
            <Step>Klicka på <Kbd>Gå med</Kbd>. Du kan nu se och skriva anteckningar i gruppen.</Step>
          </Steps>

          <h3 className="text-white font-semibold mt-6 mb-2">Administrera din grupp (admin)</h3>
          <ul className="space-y-2 text-gray-300 text-sm">
            <li className="flex gap-2"><span className="text-indigo-400 mt-0.5">▸</span>Se alla <strong className="text-white">medlemmar</strong> i gruppen.</li>
            <li className="flex gap-2"><span className="text-indigo-400 mt-0.5">▸</span><strong className="text-white">Ta bort medlemmar</strong> om det behövs.</li>
            <li className="flex gap-2"><span className="text-indigo-400 mt-0.5">▸</span>Se och dela den aktiva <strong className="text-white">inbjudningskoden</strong>.</li>
          </ul>
        </section>
        ...
        <section id="anteckningar">
          ...
          <h3 className="text-white font-semibold mb-2">Skriva en anteckning</h3>
          <Steps>
            ...
            <Step>Välj en <strong className="text-white">etikett</strong> (färgkod) för att kategorisera din notering.</Step>
          ...
          <div className="grid grid-cols-2 gap-2 sm:grid-cols-4 mt-4">
            {[
              ...
              <div key={label} className="bg-gray-900 border border-gray-800 rounded-lg p-3 flex items-start gap-2">
          ...
          <h3 className="text-white font-semibold mt-6 mb-2">Svara på en anteckning</h3>
          ...
          <h3 className="text-white font-semibold mt-6 mb-2">Viktigt att veta</h3>
          <ul className="space-y-2 text-gray-300 text-sm">
            <li className="flex gap-2"><span className="text-indigo-400 mt-0.5">▸</span>Anteckningar är synliga för <strong className="text-white">alla i din grupp</strong>.</li>
            <li className="flex gap-2"><span className="text-indigo-400 mt-0.5">▸</span>En anteckning på en häst följer med om samma häst dyker upp i en annan omgång.</li>
            <li className="flex gap-2"><span className="text-indigo-400 mt-0.5">▸</span>Du kan bara redigera/ta bort dina <strong className="text-white">egna</strong> anteckningar.</li>
          </ul>
        </section>
            ...
            <table className="w-full text-sm border border-gray-800 rounded-xl overflow-hidden">
              ...
              <tbody className="divide-y divide-gray-800">
                {[
                  ...
                  <tr key={term} className="text-gray-300 hover:bg-gray-900 transition">
                    <td className="px-4 py-2 font-medium text-white whitespace-nowrap">{term}</td>
                    <td className="px-4 py-2">{desc}</td>
                  </tr>
                ))}
              </tbody>
...
function Steps({ children }: { children: React.ReactNode }) {
  return <ol className="space-y-2 text-sm text-gray-300 list-decimal list-inside">{children}</ol>;
}
...
function Kbd({ children }: { children: React.ReactNode }) {
  return (
    <kbd className="px-1.5 py-0.5 text-xs bg-gray-800 border border-gray-700 rounded text-gray-200 font-mono">
      {children}
    </kbd>
  );
}
