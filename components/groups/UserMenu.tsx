  ...
  return (
    <>
      <div className="relative" ref={menuRef}>
        ...
        {/* Dropdown */}
        {open && (
          <div className="absolute right-0 top-11 w-56 bg-gray-900 border border-gray-700 rounded-xl shadow-2xl z-40 overflow-hidden">
            ...
            {groups.length > 0 && (
              <div className="px-4 py-2 border-b border-gray-700">
                <p className="text-gray-500 text-xs mb-1">Sällskap</p>
                {groups.map((g) => (
                  <p key={g.id} className="text-gray-300 text-xs truncate py-0.5">
                    {g.name}
                  </p>
                ))}
              </div>
            ...
            <div className="px-2 py-2 space-y-1">
              <button
                ...
                className="w-full text-left px-3 py-2 text-sm text-gray-200 hover:bg-gray-800 rounded-lg transition"
              >
                Hantera sällskap
              </button>
              <Link
